        ...
        ">
            <div class="card-body py-5 px-md-5">
                <div class="row d-flex justify-content-center">
                    ...
                    <h3 style="font-family:serif; border-bottom:solid 2px;">Edit Your Photo Here!</h3>
                    ...
                    <form action="update_foto.php" method="post" enctype="multipart/form-data">
                        ...
                        while ($data = mysqli_fetch_array($sql)) {
                            ...
                            <table cellpadding="5">
                                <tr>
                                    <td>Judul</td>
                                    <td><input type="text" name="judulfoto" class="form-control"
                                            value="<?= $data['judulfoto'] ?>"></td>
                                </tr>
                                <tr>
                                    <td>Deskripsi</td>
                                    <td><input type="text" name="deskripsifoto" class="form-control"
                                            value="<?= $data['deskripsifoto'] ?>"></td>
                                </tr>
                                <tr>
                                    <td>Lokasi File</td>
                                    <td><input type="file" name="lokasifile" class="form-control"
                                            value="<?= $data['lokasifile'] ?>"></td>
                                </tr>
                                <tr>
                                    <td>Album</td>
                                    <td>
